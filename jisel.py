...
async def dm_person(ctx, member: Member, *args):
    ...
    embed.set_footer(text="Please note that this is an automated message.  If you have any questions, please contact The Carlos/Valkyra/Symphonia or Ida")
